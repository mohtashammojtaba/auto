#!/bin/ash
#
# This script installs and configures Passwall2 on OpenWRT 24.10.7.
...
if is_installed "dnsmasq-full"; then
    ...
    if is_installed "dnsmasq"; then
        ...
        info "Visit: https://firmware-selector.openwrt.org/?version=24.10.7&target=$TARGET&id=$DEVICE_ID"
        opkg remove dnsmasq
